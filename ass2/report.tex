...
employing a model of learning styles in an educational settingover 40 years
...
and learners about learning" \cite{fleming2006learning}.  This claims visual
...
benefit from listening to lectures, oral discussions, or tapes. Finally
kinesthetic learners prefer to learn via physically doing, touching, and
experimenting.

\begin{figure}[!htbp]
    \centering
    \includegraphics[width=4in]{figures_tables/vark}
...
Concrete Observation and Abstract Conceptualization as well
as two other related approached for \textit{transforming} experience:
Reflective Observation and Active Experimentation. According to
the model, an ideal learning process will encorporate all these experiential
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=4in]{figures_tables/kolb}
